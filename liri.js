    ...
    "spotify-this-song": function (parameter) {
        ...
        if (parameter === "") {
            ...
            spotify.search({
                ...
                var artists = [];
                response.tracks.items[4].album.artists.forEach(function (element, index) {
                    artists.push(response.tracks.items[4].album.artists[index].name)
                })
                console.log("track name: " + response.tracks.items[4].name);
                console.log("artist : " + artists);
                console.log("album name: " + response.tracks.items[4].album.name);
                console.log("preview song here: " + response.tracks.items[4].preview_url);
